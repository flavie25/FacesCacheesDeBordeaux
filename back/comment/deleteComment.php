...
//
//  Script  : deleteComment.php  (ETUD)   -   BLOGART21
//
///////////////////////////////////////////////////////////////
...
?>
    <form method="post" action="./deleteComment.php" enctype="multipart/form-data">
      ...
      <fieldset>
        ...
        <div class="control-group">
            <label class="control-label" for="notifComKOAff"><b>Commentaire de modération&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</b></label>
            <input type="text" name="notifComKOAff" id="notifComKOAff" size="80" maxlength="80" value="<?= $notifComKOAff; ?>" autofocus="autofocus" />
        </div>
