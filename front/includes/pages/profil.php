        ...
        <div id="center">
            <div style="display:flex;flex-direction:row">
                <div style="display:flex;flex-direction:column;width: 40vw;">
                    ...
                    <div style="margin-top: 15%;margin-left: 0%; text-align : center"><label>Profil : </label><label id="roleProfil"><?= $infoMembre['pseudoMemb'];?></label></div>
                    <div style="margin-top: 5%;margin-left: 0%; text-align : center"><label>E-mail : </label><label id="email"><?= $infoMembre['eMailMemb'];?></label></div>
                    <div style="margin-top: 5%;margin-left: 0%; text-align : center;"><label>Mot de passe : </label><label id="mdp">**********</label></div>
                    <button style="margin-left: 50%;width: 200px;margin-top:5%" class="button2">Modifier les informations</button>
                    <button style="margin-left: 50%;width: 200px;" class="button2">Se déconnecter</button>
                    <a href="../../../back/session/deconnexion.php">Se deconnecter</a>
                ...
                <div style="display:flex;flex-direction:column" class="pseudo">
                    ...
                    <div style="display:flex;flex-direction:row">
                        <input type="text" class="formulaire" placeholder="Pseudo" value="<?= $infoMembre['pseudoMemb'];?>" disabled>
                    </div>
                </div>
            </div>
        </div>
