...
<head>
    ...
    <body>
        ...
        <div class="articles">
            ...
            <img class="img_accueil" src="img/alber.png" alt="Une image"> <!-- Image Alber -->
            ...
            <div class="droite">
                ...
                <div class="droite_svg">   
                    <p class="para_presentation">
                        Il fait partie intégrante de chaque ville 
                        <br>
                        et pourtant il reste malgré tout illégal [...] 
                    </p>   
    ...
    <!--------------------------------------------- Seconde Partie --------------------------------------------------->
        ...
        <div class="articles2">
            ...
            <img class="img_accueil" src="img/base.png" alt="Une image"> <!-- Image Base Sous Marine -->
        ...
        <div class="articles2">
            ...
            <img class="img_accueil" src="img/mascarons.png" alt="Une image"> <!-- Image Mascarons -->
            
            <div class="droite">

                <div class="droite_svg">

                    <h1 class="grand_titre"> Mascarons de <br> Bordeaux </h1> <!-- Titre -->
